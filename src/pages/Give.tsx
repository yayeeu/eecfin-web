      ...
      <section className="relative bg-eecfin-navy overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img
            ...
            loading="eager"
          />
          <div className="absolute inset-0 bg-eecfin-accent/40" />
        </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container-custom max-w-3xl mx-auto text-center">
          ...
          <p className="text-lg mb-8">
            Your generous gifts help us continue our mission of spreading the gospel
            and reaching out to those in need.
          </p>
          <Button asChild className="bg-eecfin-navy hover:bg-eecfin-navy/80">
            <Link to="/contact">
              Fundraising permission: RA/2025/336. Contact Us For More Information.
            </Link>
          </Button>
        </div>
      </section>
